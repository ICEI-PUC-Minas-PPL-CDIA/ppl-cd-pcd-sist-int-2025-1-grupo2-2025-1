...
4. **Plano de carreira estruturado** → `('P5_h ', 'Possui plano de carreira na empresa?')`
5. **Número de promoções recebidas** → `('P5_i ', 'Já foi promovido na empresa atual?')`
6. **Faixa salarial**→ `('P2_h ', 'Faixa salarial')`

### **Habilidades e Ferramentas:**


1. **Ferramentas de BI utilizadas** → `('P6_b ', 'Ferramentas de BI utilizadas')`
2. **Cloud Computing** → `('P6_c ', 'Experiência com Cloud Computing')`
