...
*   [Público alvo](#publico-alvo)
    *   [Público-Alvo da Aplicação](#publico-alvo-da-aplicacao)
*   [Stakeholders e seus Papéis](#stakeholders-e-seus-papeis)
*   [Perfis de Usuários - Personas](#perfis-de-usuarios---personas)
    *   [1. Persona: Analista de Dados Júnior](#1-persona-analista-de-dados-junior)
    *   [2. Persona: Gerente de RH em Tecnologia](#2-persona-gerente-de-rh-em-tecnologia)
    *   [3. Persona: Pesquisador de Mercado de Trabalho](#3-persona-pesquisador-de-mercado-de-trabalho)
    *   [4. Persona: Regulador de Políticas Públicas](#4-persona-regulador-de-politicas-publicas)
*   [Dicionário de dados](#dicionario-de-dados)
*   [Descrição de dados](#descricao-de-dados)
*   [Preparação dos dados](#preparacao-dos-dados)
    *   [Atributos relevantes para temática da base de dados principal](#atributos-relevantes-para-tematica-da-base-de-dados-principal)
    *   [Atributos relevantes da base de dados principal para 1ª pergunta orientada](#atributos-relevantes-da-base-de-dados-principal-para-1a-pergunta-orientada)
    *   [Atributos relevantes da base de dados principal para 2ª pergunta orientada](#atributos-relevantes-da-base-de-dados-principal-para-2a-pergunta-orientada)
    *   [Atributos relevantes da base de dados principal para 3ª pergunta orientada](#atributos-relevantes-da-base-de-dados-principal-para-3a-pergunta-orientada)
...
*   [Gráficos relacionados a dados](#graficos-relacionados-a-dados)
    *   [Gráficos relacionados a 1ª pergunta orientada a dados](#graficos-relacionados-a-1a-pergunta-orientada-a-dados)
    *   [Gráficos relacionados a 2ª pergunta orientada a dados](#graficos-relacionados-a-2a-pergunta-orientada-a-dados)
    *   [Gráficos relacionados a 3ª pergunta orientada a dados](#graficos-relacionados-a-3a-pergunta-orientada-a-dados)
*   [Enriquecimento de dados](#enriquecimento-de-dados)
    *   [Base de dados auxiliar para 1ª Pergunta Orientada a Dados](#base-de-dados-auxiliar-para-1a-pergunta-orientada-a-dados)
    *   [Base de dados auxiliar para 2ª Pergunta Orientada a Dados](#base-de-dados-auxiliar-para-2a-pergunta-orientada-a-dados)
    *   [Base de dados auxiliar para 3ª Pergunta Orientada a Dados](#base-de-dados-auxiliar-para-3a-pergunta-orientada-a-dados)
    *   [Base de dados auxiliar para 4ª Pergunta Orientada a Dados](#base-de-dados-auxiliar-para-4a-pergunta-orientada-a-dados)
    *   [Base de dados auxiliar para 5ª Pergunta Orientada a Dados](#base-de-dados-auxiliar-para-5a-pergunta-orientada-a-dados)
...
*   [Análise comparativa dos modelos](#analise-comparativa-dos-modelos)
    *   [Distribuição do modelo (opcional)](#distribuicao-do-modelo-opcional)
*   [Conclusão](#conclusao)
*   [Apêndices](#apendices)
